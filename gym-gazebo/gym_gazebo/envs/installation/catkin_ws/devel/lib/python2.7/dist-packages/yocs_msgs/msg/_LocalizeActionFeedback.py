...
"""autogenerated by genpy from yocs_msgs/LocalizeActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class LocalizeActionFeedback(genpy.Message):
  _md5sum = "c174906940145c775f10875f0919664b"
  _type = "yocs_msgs/LocalizeActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','yocs_msgs/LocalizeFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalizeActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = yocs_msgs.msg.LocalizeFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = yocs_msgs.msg.LocalizeFeedback()
