...
"""autogenerated by genpy from yocs_msgs/NavigateToActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigateToActionResult(genpy.Message):
  _md5sum = "8b1c61040f1b5f7e7ce4bb6b2de470b0"
  _type = "yocs_msgs/NavigateToActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','yocs_msgs/NavigateToResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NavigateToActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = yocs_msgs.msg.NavigateToResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = yocs_msgs.msg.NavigateToResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_Bf().pack(_x.result.success, _x.result.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.success, _x.result.distance,) = _get_struct_Bf().unpack(str[start:end])
