...
"""autogenerated by genpy from yocs_msgs/NavigateToActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class NavigateToActionFeedback(genpy.Message):
  _md5sum = "7d846f575816c69a71f167110b82fcca"
  _type = "yocs_msgs/NavigateToActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','yocs_msgs/NavigateToFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NavigateToActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = yocs_msgs.msg.NavigateToFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = yocs_msgs.msg.NavigateToFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2fb().pack(_x.feedback.distance, _x.feedback.remain_time, _x.feedback.status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.message = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.feedback.message = str[start:end]
      _x = self
      start = end
      end += 9
      (_x.feedback.distance, _x.feedback.remain_time, _x.feedback.status,) = _get_struct_2fb().unpack(str[start:end])
      return self
