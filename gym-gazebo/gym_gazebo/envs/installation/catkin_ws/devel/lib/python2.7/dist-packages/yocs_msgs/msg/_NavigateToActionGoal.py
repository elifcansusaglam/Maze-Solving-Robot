...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2b2f().pack(_x.goal.approach_type, _x.goal.num_retry, _x.goal.timeout, _x.goal.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.location = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.location = str[start:end]
      _x = self
      start = end
      end += 10
      (_x.goal.approach_type, _x.goal.num_retry, _x.goal.timeout, _x.goal.distance,) = _get_struct_2b2f().unpack(str[start:end])
      return self
