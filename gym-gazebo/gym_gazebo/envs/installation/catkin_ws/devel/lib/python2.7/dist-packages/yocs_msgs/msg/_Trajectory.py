...
"""autogenerated by genpy from yocs_msgs/Trajectory.msg. Do not edit."""
import codecs
import sys
...
class Trajectory(genpy.Message):
  _md5sum = "ff318cb77adf15ade6b9b9b13aff3a64"
  _type = "yocs_msgs/Trajectory"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# A named list of way points
Header header
string name
Waypoint[] waypoints
...
float64 w
"""
  __slots__ = ['header','name','waypoints']
  _slot_types = ['std_msgs/Header','string','yocs_msgs/Waypoint[]']
