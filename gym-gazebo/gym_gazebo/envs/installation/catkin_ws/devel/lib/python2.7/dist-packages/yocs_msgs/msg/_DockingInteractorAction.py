...
"""autogenerated by genpy from yocs_msgs/DockingInteractorAction.msg. Do not edit."""
import codecs
import sys
...
class DockingInteractorAction(genpy.Message):
  _md5sum = "fb33b77bf3a235c893241fe6926c99eb"
  _type = "yocs_msgs/DockingInteractorAction"
...
"""
  ...
  _slot_types = ['yocs_msgs/DockingInteractorActionGoal','yocs_msgs/DockingInteractorActionResult','yocs_msgs/DockingInteractorActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DockingInteractorAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = yocs_msgs.msg.DockingInteractorActionGoal()
      if self.action_result is None:
        self.action_result = yocs_msgs.msg.DockingInteractorActionResult()
      if self.action_feedback is None:
        self.action_feedback = yocs_msgs.msg.DockingInteractorActionFeedback()
    else:
      self.action_goal = yocs_msgs.msg.DockingInteractorActionGoal()
      self.action_result = yocs_msgs.msg.DockingInteractorActionResult()
      self.action_feedback = yocs_msgs.msg.DockingInteractorActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_bf3I().pack(_x.action_goal.goal.command, _x.action_goal.goal.distance, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.level
      buff.write(_get_struct_b().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.command, _x.action_goal.goal.distance, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_bf3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.level,) = _get_struct_b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
