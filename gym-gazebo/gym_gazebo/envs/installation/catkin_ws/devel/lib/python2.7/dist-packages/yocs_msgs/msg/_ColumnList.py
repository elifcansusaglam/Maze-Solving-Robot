...
"""autogenerated by genpy from yocs_msgs/ColumnList.msg. Do not edit."""
import codecs
import sys
...
class ColumnList(genpy.Message):
  _md5sum = "fdf98d2a8a0cfe17000cdb66889826b6"
  _type = "yocs_msgs/ColumnList"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Virtual column obstacles
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ColumnList, self).__init__(*args, **kwds)
