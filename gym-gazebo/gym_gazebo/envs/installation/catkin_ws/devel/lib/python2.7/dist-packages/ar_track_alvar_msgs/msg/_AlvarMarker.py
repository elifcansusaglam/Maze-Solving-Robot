...
class AlvarMarker(genpy.Message):
  _md5sum = "ef2b6ad42bcb18e16b22fefb5c0fb85f"
...
float64 w
"""
  __slots__ = ['header','id','confidence','pose']
  _slot_types = ['std_msgs/Header','uint32','uint32','geometry_msgs/PoseStamped']
