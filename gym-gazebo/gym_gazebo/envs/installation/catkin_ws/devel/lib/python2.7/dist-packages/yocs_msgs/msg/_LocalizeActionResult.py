...
"""autogenerated by genpy from yocs_msgs/LocalizeActionResult.msg. Do not edit."""
import codecs
import sys
...
class LocalizeActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "yocs_msgs/LocalizeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','yocs_msgs/LocalizeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalizeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = yocs_msgs.msg.LocalizeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = yocs_msgs.msg.LocalizeResult()
