...
(cl:defmethod cl:initialize-instance :after ((m <Column>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Column)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yocs_msgs-msg:<Column> is deprecated: use yocs_msgs-msg:Column instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Column>))
...
(cl:defmethod radius-val ((m <Column>))
...
(cl:defmethod height-val ((m <Column>))
...
(cl:defmethod pose-val ((m <Column>))
