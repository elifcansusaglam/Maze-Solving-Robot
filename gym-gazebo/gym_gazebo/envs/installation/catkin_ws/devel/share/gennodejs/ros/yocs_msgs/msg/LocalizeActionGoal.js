...
class LocalizeActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LocalizeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocalizeActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LocalizeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LocalizeGoal()
    }
