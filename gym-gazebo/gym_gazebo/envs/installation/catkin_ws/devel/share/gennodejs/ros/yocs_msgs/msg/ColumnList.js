...
class ColumnList {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.obstacles[i] = Column.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.obstacles.forEach((val) => {
      length += Column.getMessageSize(val);
    });
    return length + 4;
  }
