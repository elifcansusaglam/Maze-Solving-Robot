...
class NavigateToActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavigateToFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NavigateToActionFeedback(null);
    ...
    data.feedback = NavigateToFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += NavigateToFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigateToActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = NavigateToFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new NavigateToFeedback()
    }
...
module.exports = NavigateToActionFeedback;
