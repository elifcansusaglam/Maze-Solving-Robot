...
class LocalizeActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LocalizeFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LocalizeFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LocalizeActionFeedback(null);
    ...
    data.feedback = LocalizeFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LocalizeFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocalizeActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LocalizeFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LocalizeFeedback()
    }
...
module.exports = LocalizeActionFeedback;
