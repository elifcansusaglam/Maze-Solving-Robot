...
class NavigateToActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavigateToGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += NavigateToGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigateToActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = NavigateToGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new NavigateToGoal()
    }
...
module.exports = NavigateToActionGoal;
