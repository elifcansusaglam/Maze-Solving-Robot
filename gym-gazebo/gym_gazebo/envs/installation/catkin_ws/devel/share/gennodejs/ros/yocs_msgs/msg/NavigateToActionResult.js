...
class NavigateToActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavigateToResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += NavigateToResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigateToActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = NavigateToResult.Resolve(msg.result)
    }
    else {
      resolved.result = new NavigateToResult()
    }
...
module.exports = NavigateToActionResult;
