...
bool operator==(const ::polled_camera::GetPolledImageRequest_<ContainerAllocator1> & lhs, const ::polled_camera::GetPolledImageRequest_<ContainerAllocator2> & rhs)
{
  return lhs.response_namespace == rhs.response_namespace &&
...
struct Definition< ::polled_camera::GetPolledImageRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Namespace to publish response topics in. A polled camera driver node\n"
"# should publish:\n"
